 ...
 */
final class Version20240305115702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE travaux ADD comment_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE travaux ADD CONSTRAINT FK_6C24F39BF8697D13 FOREIGN KEY (comment_id) REFERENCES comment (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6C24F39BF8697D13 ON travaux (comment_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE travaux DROP FOREIGN KEY FK_6C24F39BF8697D13');
        ...
        $this->addSql('DROP INDEX UNIQ_6C24F39BF8697D13 ON travaux');
        $this->addSql('ALTER TABLE travaux DROP comment_id');
    }
}
